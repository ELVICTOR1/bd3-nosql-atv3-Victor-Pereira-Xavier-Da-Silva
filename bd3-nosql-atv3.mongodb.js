...
/* ALTERAR O NOME USANDO O CPF COMO CRITÉRIO */

// db['bd3-nosql-atv1'].updateOne(
//      {cpf: "901.234.567-88"}, //CLAUSULA (WHERE)
//      {$set:{nome: "Victor Pereira"}} //VALOR A SER ALTERADO
// );

/* ALTERAR O TELEFONE DE UM ALUNO COM O RG COMO CRITÉRIO */

// db['bd3-nosql-atv1'].updateOne(
//     {rg: "89.012.345-6"}, //CLAUSULA (WHERE)
//     {$set:{telefone_aluno: "(51) 98002-4567"}} //VALOR A SER ALTERADO
// );

/* EXCLUIR UM ALUNO USANDO O RG COMO CRITÉRIO */

// db['bd3-nosql-atv1'].deleteOne({rg:'12.345.678-9'});

/* EXCLUIR UM ALUNO USANDO O CPF COMO CRITÉRIO */

// db['bd3-nosql-atv1'].deleteOne({cpf:'234.567.890-11'});